...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xugrid-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14877&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xugrid-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xugrid` can be installed with:

```
conda install xugrid
```

It is possible to list all of the versions of `xugrid` available on your platform with:
